...
$(function () {
    $("#single-room-property-filter").click(function () {
        $.ajax({
            url: "/propertyListSingleRoom",
            type: "GET",
            success: function (data) {
                ...
                $("#property-tabs-single-room").addClass("active");
    ...
    function ajaxDataAndDomManipulator(indexId) {
        ...
        console.log(loopStartingIndex);
        console.log(loopEndingIndex);
